...
static string passModelName = "100100";
...
public:
    ...
    */
    ...
    static void ChangePassModelName(string name);
    ...
    * @brief   读取Json文件
    *
    * @param[in]   filename   文件名，例如"100650/100650.json"
    * @param[in]   model_id   _model的编号
    */
    void ReadJsonFromFile(char *filename, int model_id);
    ...
    * @param[in]   y   画面のY座標
    */
    void OnTap(Csm::csmFloat32 x, Csm::csmFloat32 y,float pointX, float pointY);
    ...
    *           サンプルアプリケーションではモデルセットの切り替えを行う。
    */
    void ChangeScene(Csm::csmInt32 index, string modelName = "");
